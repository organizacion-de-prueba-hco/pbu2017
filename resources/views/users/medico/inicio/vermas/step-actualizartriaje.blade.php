...
<h2 class="StepTitle">III. TRIAJE</h2>
			<hr>
				{!! Form::open(['method'=>'post','id'=>'elformulario1-triaje','class'=>'form-horizontal form-label-left']) !!}								
									...
									<div align="center" ><br>
                          			...
                          			<input type="submit" value="Actualizar" class="btn btn-info" onclick="lafuncion('/medmeds/actualizartriaje','#elformulario1-triaje','#step-33')">
            						</div>
