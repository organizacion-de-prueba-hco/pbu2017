   ...
   <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">                        
                          {!! Form::open(['url' => 'meds/foto','method'=>'post', 'class'=>'form-horizontal form-label-left','enctype'=>'multipart/form-data']) !!}
...
<script type="text/javascript">
    ...
    function foto2(evt) {
      ...
      document.getElementById('files-foto-e').addEventListener('change', foto2, false);
