...
<div class="hr dotted"></div>
							...
							<!-- PAGE CONTENT BEGINS -->
{!! Form::open(['route' => ['suestudiantes.update'],'method' => 'PUT', 'class'=>'form-horizontal']) !!}
<div class="col-xs-12">	
									...
									@else
										...
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Tipo de Beca </label>
										<div class="col-sm-9">
										{!!Form::select('TipoBeca',['A'=>'A','B'=>'B','C'=>'C'],null,['required','id'=>'beca','class'=>'col-xs-10 col-sm-5','placeholder' => 'Seleccione'])!!}
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Estado </label>
										<div class="col-sm-9">
										{!!Form::select('estado',['1'=>'Aprobado','0'=>'Desaprobado'],null,['required','id'=>'beca','class'=>'col-xs-10 col-sm-5','placeholder' => 'Seleccione'])!!}
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Observaciones </label>
