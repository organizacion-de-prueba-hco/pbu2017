                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">                        
                          {!! Form::open(['url' => 'suajustes/foto','method'=>'post', 'class'=>'form-horizontal form-label-left','enctype'=>'multipart/form-data']) !!}
			...
			<div align="center">
				...
				<span class="profile-picture">
					<img id="avatar" alt="avatar" src="{{url('imagenes/avatar/'.Auth::user()->foto)}}" height="170px;">
								...
								<!-- PAGE CONTENT BEGINS -->
	{!! Form::open(['route' => 'suajuste.store', 'method' => 'POST', 'class'=>'form-horizontal']) !!}
