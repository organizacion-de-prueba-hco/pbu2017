...
@endsection
@section('contenido')
@include('users.jufc.matricula.eliminar')
					...
					@foreach($matriculas as $m)
						<tr>
							...
							<div class="action-buttons">
								<a class="red" href="#" onclick="eliminar('{{$m->id}}')"  title="Eliminar" data-toggle="modal" data-target="#eliminar">
									<i class="ace-icon fa fa-trash bigger-130"></i>
								</a>
								<a class="green" href="#" onclick="Cambiarnota('{{$m->id}}')" title="Editar"  data-toggle="modal" data-target="#nota">
