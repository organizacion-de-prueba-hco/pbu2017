...
<!-- PAGE CONTENT BEGINS -->
								<br>
{!! Form::open(['route' =>'jufcmatricula.store', 'method' => 'POST','class'=>'form-horizontal']) !!}
...
@else
	<h3>¡Error! <span> El Código ingresado no existe</span></h3><a href="{{url('jufcmatricula')}}">volver</a>
@endif
@endsection
@section('script')
