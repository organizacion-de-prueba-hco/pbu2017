...
@section('contenido')
	...
	<div class="col-xs-12">
		...
		<div class="table-header">
			<a href="{{route('jufctaller.create')}}" class="btn btn-success btn-xs btn-round" title="Nuevo" data-toggle="modal">
			...
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<a href="{{route('jufctaller.edit',$t)}}" data-toggle="tooltip" title="Editar">
							<span class="green">
