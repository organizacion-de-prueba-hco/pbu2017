                    ...
                    <div class="modal-dialog modal-sm">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="modal-footer">
                          ...
                          <input type="button" class="btn btn-success" value="Actualizar" data-dismiss="modal" onclick="lafuncion('/psicoinicios/editaringresofamiliar','#elformulario3-editar','#step-33')">
                        </div>
