      ...
      <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="modal-footer col-md-12">
                  ...
                  <input type="button" class="btn btn-danger" value="Eliminar" data-dismiss="modal" onclick="lafuncion('/psicoinicios/eliminarcfamiliar','#elformulario2-0','#step-22');lafuncion('/psicoinicios/gastosyotrosdatos','#elformulario3-gastosyotrosdatos','#step-33');">
                  <input type="button" class="btn btn-success" value="Actualizar" data-dismiss="modal" onclick="lafuncion('/psicoinicios/ecfamiliar','#elformulario2-0','#step-22');lafuncion('/psicoinicios/gastosyotrosdatos','#elformulario3-gastosyotrosdatos','#step-33');">
               </div>
         {!! Form::close() !!}
      </div>
   </div>
