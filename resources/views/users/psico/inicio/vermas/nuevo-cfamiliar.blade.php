   ...
   <div class="modal-dialog modal-sm">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            ...
            data-dismiss="modal" onclick="lafuncion('/psicoinicios/nuevocfamiliar','#elformulario2-nuevo','#step-22');lafuncion('/psicoinicios/gastosyotrosdatos','#elformulario3-gastosyotrosdatos','#step-33');">
         </div>
         {!! Form::close() !!}
      </div>
   </div>
