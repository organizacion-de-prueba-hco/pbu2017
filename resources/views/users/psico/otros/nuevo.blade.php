...
<div class="col-xs-12">
								...
								{!! Form::open(['route' => 'psicotro.store', 'method' => 'POST', 'class'=>'form-horizontal']) !!}
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										{!!Form::textarea('t_inteligencia',null,['required','id'=>'obs','class'=>'col-xs-10 col-sm-5','placeholder' => 'Escribir aquí...'])!!}
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Test de Ansiedad</label>
										<div class="col-sm-9">
										{!!Form::textarea('t_ansiedad',null,['required','id'=>'obs','class'=>'col-xs-10 col-sm-5','placeholder' => 'Escribir aquí...'])!!}
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Test de Personalidad</label>
										<div class="col-sm-9">
										{!!Form::textarea('t_personalidad',null,['required','id'=>'obs','class'=>'col-xs-10 col-sm-5','placeholder' => 'Escribir aquí...'])!!}
										</div>
									</div>
