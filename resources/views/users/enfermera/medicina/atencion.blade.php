				...
				<div class="modal-content">
					...
					<div class="modal-body" align="center">Ingrese Cód/DNI del paciente<br>
						...
						<span class="input-icon">
							<input type="number" placeholder="Cód Univ. o DNI" class="nav-search-input" maxlength="10" required="required" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="cod" >
