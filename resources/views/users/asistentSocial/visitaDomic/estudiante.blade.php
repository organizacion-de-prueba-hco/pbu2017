	...
	<div class="col-xs-12">
		...
		<div id="nuevo-dj" class="modal fade" tabindex="-1">
			<div class="modal-dialog">
					...
					<div class="modal-body" align="center">
							...
							{!! Form::open(['url' => 'asvisitadomc1s/nuevo', 'method' => 'POST']) !!}
		...
		<div class="table-responsive">
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					@foreach($visitadomiciliaria as $vd)
						<tr>
							<td>{{$vd->created_at}}</td>
							...
							<td>
							@if($vd->parentesco=='YO')
							{{$vd->cuadrofamiliar->parentesco}}: 
							@endif
							{{$vd->cuadrofamiliar->nombres}}
							</td>
							<td>
							<div class="hidden-sm hidden-xs action-buttons">
								<a class="orange" href="{{url('pdf/visitadomiciliaria',$vd->id)}}" target="_black" title="Descargar como PDF">
									<i class="ace-icon fa fa-file-pdf-o bigger-130"></i>
								</a>
								<a class="green" href="{{route('asvisitadomc1.edit',$vd->id)}}" title="Editar" data-toggle='tooltip'>
							...
							<div class="inline pos-rel">
								...
								<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
									<li>
										<a href="{{url('pdf/visitadomiciliaria',$vd->id)}}" class="tooltip-info" data-rel="tooltip" title="Descargar como PDF" target="_black">
											<span class="orange">
