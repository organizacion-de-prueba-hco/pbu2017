   ...
   <div class="modal-dialog modal-sm">
      <div class="modal-content">
         <div class="modal-header">
            ...
            {!! Form::open(['url'=>'asvisitahosp1s/nuevopariente', 'method'=>'post','class'=>'form-horizontal form-label-left']) !!}
...
<!-- PAGE CONTENT BEGINS -->
								<br>
								{!! Form::open(['route' => 'asvisitahosp1.store', 'method' => 'POST', 'class'=>'form-horizontal']) !!}
