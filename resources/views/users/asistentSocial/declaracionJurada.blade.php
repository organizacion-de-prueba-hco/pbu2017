					...
					@foreach($declaracionjuradas as $declaracionjurada)
						<tr>
							...
							<div class="hidden-sm hidden-xs action-buttons">
								<a class="orange" href="{{url('pdf/dj',$declaracionjurada->miembro_familiar)}}" target="_black" title="Descargar como PDF">
							...
							<div class="inline pos-rel">
								...
								<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
									<li>
										<a href="{{url('pdf/dj',$declaracionjurada->miembro_familiar)}}" class="tooltip-info" data-rel="tooltip" title="Descargar como PDF" target="_black">
											<span class="orange">
