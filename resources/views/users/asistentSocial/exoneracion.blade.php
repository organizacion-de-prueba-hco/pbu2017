	...
	<div class="col-xs-12">
		...
		<div class="table-responsive">
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						<th class="center">N° de Exon. Pago Centro Médico</th>
						<th>Estudiante</th>
						<th>Revisado por</th>
						<th></th>
					</tr>
				...
				<tbody>
					@foreach($exoneraciones as $exoneracion)
						<tr>
							<td class="center">{{$exoneracion->id}}</td>
							<td class="hidden-480">{{$exoneracion->estudiante}}</td>
							<td class="hidden-480" align="center">{{$exoneracion->asistenta_social}}</td>
