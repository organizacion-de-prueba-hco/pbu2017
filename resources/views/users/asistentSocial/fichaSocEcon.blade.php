					...
					@foreach($fichaSocEcon as $expediente)
						<tr>
							...
							<div class="hidden-sm hidden-xs action-buttons">
								...
								<a class="green" href="{{route('asfichasocial.edit',$expediente->expediente)}}">
							...
							<div class="inline pos-rel">
								...
								<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
									...
									<li>
										<a href="{{route('asfichasocial.edit',$expediente->expediente)}}" class="tooltip-success" data-rel="tooltip" title="Editar">
											<span class="green">
