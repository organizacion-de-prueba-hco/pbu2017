...
@section('activacion')
	...
	?>
@endsection
@section('titulo','Editar Declaración Jurada')
@section('estilos')
@endsection
@section('ruta')
<ul class="breadcrumb">
	...
	<li class="active">Editar/Actualizar</li>
</ul>
@endsection
@section('contenido')
@if($estudiante)
...
<!-- PAGE CONTENT BEGINS -->
								<br>
								{!! Form::model($dj,['route' => ['asdeclaracionjurada.update', $dj->id], 'method' => 'PUT', 'class'=>'form-horizontal']) !!}
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-9">
											<div class="clearfix">
												{!!Form::select('departamento',$departamentos, $dj->distrit->provincia->departamento_id, ['required','id'=>'departamento_nac', 'class'=>'col-xs-10 col-sm-5','placeholder' => 'Departamento'])!!}
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-9">
											<div class="clearfix">
												{!!Form::select('provincia',$provincias, $dj->distrit->provincia_id, ['id'=>'provincia_nac','class'=>'col-xs-10 col-sm-5','placeholder' => 'Provincia'])!!}
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-9">
											<div class="clearfix">
												{!!Form::select('distrito',$distritos,$dj->distrito, ['id'=>'distrito_nac', 'class'=>'col-xs-10 col-sm-5','placeholder' => 'Distrito'])!!}
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
										{!!Form::text('desempenio_como',$dj->desempenio_como,['required','class'=>'col-xs-10 col-sm-5','placeholder' => 'Se desempeña como'])!!}
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Haber mensual S/ </label>
										<div class="col-sm-9">
										{!!Form::number('haber_mensual',$dj->haber_mensual, ['required','id'=>'obs','class'=>'col-xs-10 col-sm-5','placeholder' => 'Escribir aquí...'])!!}
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> N° Hijos </label>
										<div class="col-sm-9">
										{!!Form::number('n_hijos',$dj->n_hijos, ['required','id'=>'obs','class'=>'col-xs-10 col-sm-5','placeholder' => 'Escribir aquí...'])!!}
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Apoyo mensual con (S/.) </label>
										<div class="col-sm-9">
										{!!Form::number('apoyo_mensual',$dj->apoyo_mensual, ['required','id'=>'obs','class'=>'col-xs-10 col-sm-5','placeholder' => 'Apoyo mensual con S/.'])!!}
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Otros Gastos </label>
										<div class="col-sm-9">
										{!!Form::text('otros_gastos',$dj->otros_gastos, ['required','id'=>'obs','class'=>'col-xs-10 col-sm-5','placeholder'=>'Escriba aquí...'])!!}
										</div>
									</div>
...
<script type="text/javascript">
    ...
    function pariente(){
    	var pariente=<?php echo $dj->miembro_familiar; ?>;
