...
@section('activacion')
	<?php
$a='';$rcMenu=''; $b=''; $c1=''; $c2='';$c='';$c3=''; $c4='';$d='';$d1=''; $d2=''; $d3=''; $d4='';$e='';
?>
@endsection
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">                        
                          {!! Form::open(['url' => 'asajustes/foto','method'=>'post', 'class'=>'form-horizontal form-label-left','enctype'=>'multipart/form-data']) !!}
			...
			<div align="center">
				...
				<span class="profile-picture">
					<img id="avatar" alt="avatar" src="{{url('imagenes/avatar/'.Auth::user()->foto)}}" height="170px;">
								...
								<!-- PAGE CONTENT BEGINS -->
	{!! Form::open(['route' => 'asajuste.store', 'method' => 'POST', 'class'=>'form-horizontal']) !!}
