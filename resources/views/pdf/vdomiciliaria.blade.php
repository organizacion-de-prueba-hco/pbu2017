...
<body>
  ...
  <div id="content" style="margin-left: 30px; margin-right: 30px;">
    ...
    <h2 align="center" style="font-size: 23px; font-family: fantasy;"><u>VISITA DOMICILIARIA</u></h2>
  <br>
    ...
    <div>
      ...
      <p><b>DOMICILIO: </b>{{$vd->cuadrofamiliar->user->domicilio.' '.$vd->cuadrofamiliar->user->n_domicilio}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>TELÉFONO: </b>{{$vd->cuadrofamiliar->user->telefono}} </p>
      ...
      <p><b>DOMICILIO: </b>{{$vd->cuadrofamiliar->residencia}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>TELÉFONO: </b>{{$vd->cuadrofamiliar->user->telefono}} </p>      
      @endif
      <br>
      <p><b>MOTIVO DE VISITA: </b></p>
      <p>{{$vd->motivo}}</p><br>
      <p><b>DIAGNÓSTICO SITUACIONAL: </b></p>
