...
class JufcMatriculaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $matricula->save();
        return Redirect::to('jufcmatricula')->with('verde','Se registró un nuevo estudiante');
    }
    ...
    public function edit($id)
    {
        ...
        return view('users.jufc.matricula.notas',compact('notas'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return Redirect::to('jufcmatricula')->with('verde','Se actualizaron las notas');
    }
    ...
    public function getEliminar($id){
        ...
        return Redirect::to('jufcmatricula')->with('verde','Se eliminó correctamente');
    }
}
