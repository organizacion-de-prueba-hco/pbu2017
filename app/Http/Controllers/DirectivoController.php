...
class DirectivoController extends Controller
{
    public function __construct()
   {
    ...
    {
        return view('users.directivo.ajustes');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($user->save()){
            return Redirect::to('directivoajuste')->with('verde','Se actulizaron los datos');
        }else{
            return Redirect::to('directivoajuste')->with('rojo','Los datos ingresados no son válidos');            
        }
    }
