...
class JufcController extends Controller
{
    /**
    ...
    {
        return view('users.jufc.ajustes');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($user->save()){
            return Redirect::to('jufc')->with('verde','Se actulizaron los datos');
        }else{
            return Redirect::to('jufc')->with('rojo','Los datos ingresados no son válidos');            
        }
    }
